...
export class ClienteComponent implements OnInit {
  ...
  constructor(
    ...
    /**
     * Obteniendo parámetros del routing para saber si se está creando o editando un cliente
     * y así armar los formularios respectivamente.
     */
    this.params = router.getCurrentNavigation()?.extras.state as Cliente;
    if (!this.params) {
      this.formType = 'crear';
      ...
      this.clienteForm = this.formBuilder.group({
        cedula_cliente: [
          { value: this.params.cedula_cliente, disabled: true },
          Validators.required,
        ],
        ...
        correo_cliente: [this.params.correo_cliente, Validators.required],
        password_cliente: [this.params.password_cliente, Validators.required],
        telefono_1: [
        ...
        provincia_1: [
          this.params.direcciones[0].provincia,
          Validators.required,
        ],
        canton_1: [this.params.direcciones[0].canton, Validators.required],
        distrito_1: [this.params.direcciones[0].distrito, Validators.required],
        provincia_2: [
          this.params.direcciones[1]
            ? this.params.direcciones[1].provincia
            : null,
        ],
        canton_2: [
          this.params.direcciones[1] ? this.params.direcciones[1].canton : null,
        ],
        distrito_2: [
          this.params.direcciones[1]
            ? this.params.direcciones[1].distrito
            : null,
        ],
      });
    }
          ...
          this.localidadService.ObtenerCantones(this.id_provincia_1).subscribe({
            next: (localidadesResponse: LocalidadesResponse) => {
              ...
              this.id_canton_1 = this.identificarCanton1(
                this.params.direcciones[0].canton
              );
                ...
                .subscribe({
                  next: (localidadesResponse: LocalidadesResponse) => {
                    ...
                    this.id_distrito_1 = this.identificarDistrito1(
                      this.params.direcciones[0].distrito
                    );
              ...
              .subscribe({
                next: (localidadesResponse: LocalidadesResponse) => {
                  ...
                  this.id_canton_2 = this.identificarCanton2(
                    this.params.direcciones[1].canton
                  );
  ...
  formatoCliente(clienteFormValues: any) {
    return {
      cedula_cliente:
        this.formType === 'editar'
          ? this.params.cedula_cliente
          : clienteFormValues.cedula_cliente,
      ...
      puntos_acum: this.formType === 'editar' ? this.params.puntos_acum : 0,
      puntos_obt: this.formType === 'editar' ? this.params.puntos_obt : 0,
      puntos_redim: this.formType === 'editar' ? this.params.puntos_redim : 0,
      direcciones:
